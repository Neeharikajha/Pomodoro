...
function RemoteVideoTile({ player, stream, videoSize, }) {
    ...
    return (_jsx("div", { className: "absolute pointer-events-none", style: {
            ...
            width: videoSize,
        }, children: _jsx("div", { className: "rounded-lg overflow-hidden border border-stone-700 bg-black/80 shadow-lg", children: hasLiveVideoTrack ? (_jsx("video", { ref: ref, autoPlay: true, playsInline: true, muted: true, className: "w-full h-full object-cover", style: { height: videoSize * 0.75 } })) : (_jsx("div", { className: "flex items-center justify-center text-xs text-stone-400", style: { height: videoSize * 0.75 }, children: "camera off" })) }) }));
}
