...
export const LEFT_BOTTOM_FURNITURE = [
    // Green Plant 1 - center 20%
    {
        x: 140 + 30 * 0.4,
        y: STAGE_HEIGHT - 180 + 30 * 0.4,
        width: 30 * 0.2,
        height: 30 * 0.2,
    },
...
const rx = (right, w) => STAGE_WIDTH - right - w;
// Helper: convert CSS right/bottom to canvas x
const rxb = (right, w) => STAGE_WIDTH - right - w;
// Helper: convert CSS bottom to canvas y
const by = (bottom, h) => STAGE_HEIGHT - bottom - h;
...
export const RIGHT_ALL_FURNITURE = [
...
export const BENCHES = [
    ...
    {
        rect: { x: 80, y: STAGE_HEIGHT - 70 - 96, width: 48, height: 96 },
        sitZone: { x: 80, y: STAGE_HEIGHT - 70 - 96, width: 48, height: 96 },
        sitX: 104,
        sitY: STAGE_HEIGHT - 70 - 48,
    },
    // Bottom Red Sofa 1 (horizontal, rotated -90deg, at left: 150px, bottom: 1px)
    {
        rect: { x: 150, y: STAGE_HEIGHT - 1 - 48, width: 96, height: 48 },
        sitZone: { x: 150, y: STAGE_HEIGHT - 1 - 48 - 40, width: 96, height: 88 },
        sitX: 198,
        sitY: STAGE_HEIGHT - 1 - 48 - 48, // sit above the sofa
    },
    // Bottom Red Sofa 2 (horizontal, rotated -90deg, at left: 240px, bottom: 1px)
    {
        rect: { x: 240, y: STAGE_HEIGHT - 1 - 48, width: 96, height: 48 },
        sitZone: { x: 240, y: STAGE_HEIGHT - 1 - 48 - 40, width: 96, height: 88 },
        sitX: 288,
        sitY: STAGE_HEIGHT - 1 - 48 - 48, // sit above the sofa
    },
    ...
    {
        rect: { x: 80, y: STAGE_HEIGHT - 380 - 52, width: 52, height: 52 },
        sitZone: { x: 80, y: STAGE_HEIGHT - 380 - 52, width: 52, height: 52 },
        sitX: 106,
        sitY: STAGE_HEIGHT - 380 - 26,
    },
    // Chair 2 (at left: 200px, bottom: 380px)
    {
        rect: { x: 200, y: STAGE_HEIGHT - 380 - 52, width: 52, height: 52 },
        sitZone: { x: 200, y: STAGE_HEIGHT - 380 - 52, width: 52, height: 52 },
        sitX: 226,
        sitY: STAGE_HEIGHT - 380 - 26,
    },
