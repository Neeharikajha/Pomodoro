...
const rx = (right: number, w: number) => STAGE_WIDTH - right - w;
// Helper: convert CSS right/bottom to canvas x
const rxb = (right: number, w: number) => STAGE_WIDTH - right - w;
// Helper: convert CSS bottom to canvas y
const by = (bottom: number, h: number) => STAGE_HEIGHT - bottom - h;
